...
import uz.impulse.impulse.adapter.HomeItemAdapter
import uz.impulse.impulse.databinding.DialogHomeViewBinding
import uz.impulse.impulse.databinding.FragmentHomeBinding
import uz.impulse.impulse.manager.PrefsManager
import uz.impulse.impulse.model.HomeItem
...
class HomeFragment : BaseFragment() {
    ...
    private fun getAllItems(): ArrayList<HomeItem> {
        ...
        items.add(HomeItem(getString(R.string.str_accident), R.mipmap.ic_injury))
